...
function createFeatures(earthquakeData) {
    ...
    // Give each feature a popup describing the Magnitude, Depth, Place, & time of the earthquake
...
function createMap(mags) {
  ...
  let myMap = L.map("map", {
   ...
   // Define light-v10 map layer and add it to the map
   ...
   // Set up the legend
    ...
    let legendInfo = `<h3>Earthquake <br> Depth (km) </h3>`;
